pragma Ada_95;
pragma Warnings (Off);
pragma Source_File_Name (ada_main, Spec_File_Name => "b~add_int_w_io.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~add_int_w_io.adb");
...
--  BEGIN Object file/option list
   --   ./add_int_w_io.o
   --   -L./
   --   -L/usr/lib/gcc/arm-linux-gnueabihf/6/adalib/
   --   -shared
   --   -lgnat-6
